...
import com.place.helper.api.LoginStatus;
import com.place.helper.api.PreLoginInfo;
import com.place.helper.common.util.BigIntegerRSA;
import com.place.helper.common.util.Constans;
import com.place.helper.common.util.CookieConfig;
import com.place.helper.common.util.Tools;
...
public class WeiboLoginService {
	...
	public WeiboLoginService() {
		this.client = CookieConfig.configeClient(null);
	}
	...
	public LoginStatus getLoginStatus(String entity, PreLoginInfo info){
		if(entity.indexOf("code=0") == -1) {
			...
			logger.error("��½ʧ��:" + URLDecoder.decode(entity.substring(entity.indexOf("reason=") + 7,
	...
	public PreLoginInfo getPreLoginInfo(){
		...
		try {
			...
			logger.error("��½ʧ��,��ȷ����������ȷ���磡" + var24);
			return null;
		} catch (JSONException var25) {
			logger.error("Json����ʧ�ܣ�" + var25);
			return null;
		}
		return info;
	}
	...
	public CookieStore getCookieStore(String entity) {
		...
		try {
			CloseableHttpClient client = CookieConfig.configeClient(null);
	...
	private PreLoginInfo getPreLoginBean(HttpClient client, String username) 
		...
		//retcode=102  �˺Ŷ���    retcode=103 �������� û����Ϣ    �����п����ǵ���
