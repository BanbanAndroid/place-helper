...
public class PosiAdmin {
	...
	//private static String[] zhanjiang = {"赤坎区","霞山区","坡头区","麻章区","廉江市","吴川市","雷州市","遂溪县","徐闻县"};
	private static String[] zhaoqing = {"端州区","鼎湖区","高要区","四会市","广宁县","怀集县","封开县","德庆县"};
	...
	public static void main(String[] args) {
		...
		poisSerivice.savePoisz(zhaoqing);
